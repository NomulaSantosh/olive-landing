...
const HeroSection = () => (
  <section style={{
    ...
    alignItems: "center",
    textAlign: "center",
    padding: "64px 16px 0",   /* top gap from navbar */
  }}>
    ...
    <div className="anim-1" style={{
      ...
      alignItems: "center",
      gap: 12,
      marginBottom: 48,        /* gap below social proof before headline */
    }}>
    ...
    <h1 className="anim-2" style={{
      ...
      fontWeight: 600,
      lineHeight: 1.1,
      marginBottom: 28,        /* gap below headline */
    ...
    <p className="anim-3" style={{
      ...
      fontSize: 17,
      lineHeight: 1.7,
      marginBottom: 40,        /* gap below subtext before button */
      maxWidth: 460,
    }}>
    ...
    {/* 4 — CTA button */}
    <div className="anim-4" style={{ marginBottom: 72 }}>  {/* gap below button before phone */}
